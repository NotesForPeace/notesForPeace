...
?>
        <!-- Footer -->
        <div id="footer" class="container-fluid nfp-footer py-3">

            <!-- Email and Socila Media Links -->
            <div id="footer-contact" class="row justify-content-center">
                ...
                <!-- Facebook -->
                <div class="px-3">
                    <a href="https://business.facebook.com/notesforpeacechicago/" class="nfp-footer-icon-soc">
                ...
                <!-- Instagram -->
                <div class="px-3">
                    <a href="https://www.instagram.com/notesforpeace_chicago/" class="nfp-footer-icon-soc">
